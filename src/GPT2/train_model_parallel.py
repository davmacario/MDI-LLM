...
"""
Ideas:
    - Select device list from args OR use "--use-all-devices" flag to use all GPUs
    - Allow for RAM offloading by including "CPU" in the list (maybe add flag
    "--offload" to achieve this - CPU not included by default as it's slow)
"""
